...
public class DataHandler
{
    public static void DataHandleJson(string dataJson, string dataType, string fileName)
    {
        ...
        void CreateExportMenu()
        {
            ...
            string[] optionsData = { "Print to console", "Download as JSON", "Download as CSV", "End export" };
                        ...
                        case "price":
                            ...
                            else
                            {
                                Dictionary<string, MultiplePricesClass.Price> priceRoot =
                                    JsonConvert.DeserializeObject<Dictionary<string, MultiplePricesClass.Price>>(
                                        dataJson);
